...
export default async function RestaurantDetail({ params }: RestaurantDetailProps) {
  ...
  const title1 = restaurant!.MAIN_TITLE || '제목 없음';
            ...
            <div className='flex flex-col space-y-2 text-3xl mx-30'>
              ...
              {restaurant!.USAGE_DAY_WEEK_AND_TIME && (
                <div className='flex justify-between items-start'>
                  ...
                  <p className='text-right'>{restaurant!.USAGE_DAY_WEEK_AND_TIME}</p>
                </div>
              )}
              ...
              {restaurant!.CNTCT_TEL && (
                <div className='flex justify-between items-start'>
                  ...
                  <p className='text-right'>{restaurant!.CNTCT_TEL}</p>
                </div>
              )}
              ...
              {restaurant!.RPRSNTV_MENU && (
                <div className='flex justify-between items-start'>
                  ...
                  <p className='text-right'>{restaurant!.RPRSNTV_MENU}</p>
                </div>
              )}
              ...
              {restaurant!.HOMEPAGE_URL && (
                <div className='flex justify-between items-start'>
                  ...
                  <a href={restaurant!.HOMEPAGE_URL} target="_blank" rel="noopener noreferrer" className='hover:text-blue-500 line-clamp-1 text-right break-all'>
                    {restaurant!.HOMEPAGE_URL}
                  </a>
                </div>
              )}
