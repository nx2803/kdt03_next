    ...
    return (
      <div className="flex flex-col items-center justify-center h-full">
        ...
        <button
          ...
          className=" flex flex-row cursor-pointer bg-zinc-700  rounded hover:bg-zinc-600"
        >
    ...
    return (
      ...
      <div className="flex flex-col items-center justify-center h-full">
        ...
        <button
          ...
          className="px-4 py-2 bg-zinc-700 font-semibold rounded  hover:bg-red-600 transition-all  duration-200 ease-in-out"
        >
          로그아웃
        </button>
      </div>
